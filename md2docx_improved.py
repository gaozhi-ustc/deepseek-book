...
# -*- coding: utf-8 -*-
"""
Markdown 转 DOCX 工具 - 改进版
公式用蓝色斜体标记，方便在 Word 中识别和转换
"""
...
class MarkdownToDocx:
    ...
    def add_paragraph(self, text, style='Normal'):
        ...
        for part in parts:
            if part.startswith('$') and part.endswith('$'):
                ...
                self.set_font(run, 'Cambria Math', 11, italic=True, color=RGBColor(0, 0, 255))
    ...
    def save(self, output_file):
        ...
        print("提示: 公式以蓝色斜体标记，可在 Word 中使用公式编辑器转换")


def main():
    parser = argparse.ArgumentParser(description='Markdown 转 DOCX 工具（改进版）')
